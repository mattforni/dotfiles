...
const configure_shell_1 = require("./configure-shell");
...
function activate(context) {
    ...
    let applyConfiguration = function (config) {
        ...
        let args;
        [config.shell, args] = (0, configure_shell_1.configureShell)();
    };
    ...
    var startLanguageServer = function () {
        languageClient = (0, language_client_1.makeLanguageClient)(solargraphConfiguration);
