...
`;var pt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,ut=(e,t,o,n)=>{for(var s,r=n>1?void 0:n?ft(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&pt(t,o,r),r};let bt=class extends et{constructor(){super(...arguments),this.full=!1,this.tabIndex=0}get role(){return this.href?"link":"button"}render(){const e=Fe`<slot></slot>`;return null!=this.href?Fe`<a href=${this.href}>${e}</a>`:e}};bt.styles=[ht,Y`
		...
		`],ut([st({type:Boolean,reflect:!0})],bt.prototype,"full",2),ut([st()],bt.prototype,"href",2),ut([st({reflect:!0})],bt.prototype,"role",1),ut([st()],bt.prototype,"appearance",2),ut([st({type:Number,reflect:!0})],bt.prototype,"tabIndex",2),bt=ut([ot("gk-button")],bt);var gt=Object.defineProperty,yt=Object.getOwnPropertyDescriptor,vt=(e,t,o,n)=>{for(var s,r=n>1?void 0:n?yt(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&gt(t,o,r),r};let xt=class extends et{render(){const e=Fe`
			<div class="header">
