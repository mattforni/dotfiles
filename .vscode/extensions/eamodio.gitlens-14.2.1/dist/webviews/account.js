...
`;var ut=Object.defineProperty,dt=Object.getOwnPropertyDescriptor,ft=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?dt(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&ut(t,o,i),i};let pt=class extends ot{constructor(){super(...arguments),this.full=!1,this.tabIndex=0}get role(){return this.href?"link":"button"}render(){const e=Oe`<slot></slot>`;return null!=this.href?Oe`<a href=${this.href}>${e}</a>`:e}};pt.styles=[lt,oe`
		...
		`],ft([st({type:Boolean,reflect:!0})],pt.prototype,"full",2),ft([st()],pt.prototype,"href",2),ft([st({reflect:!0})],pt.prototype,"role",1),ft([st()],pt.prototype,"appearance",2),ft([st({type:Number,reflect:!0})],pt.prototype,"tabIndex",2),pt=ft([rt("gl-button")],pt);var gt=Object.defineProperty,mt=Object.getOwnPropertyDescriptor,vt=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?mt(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&gt(t,o,i),i};let yt=class extends ot{constructor(){super(...arguments),this.editor=!1}render(){return Oe`<div class="group"><slot></slot></div>`}};yt.styles=[lt,oe`
			:host {
				display: block;
				max-width: 30rem;
				margin-right: auto;
