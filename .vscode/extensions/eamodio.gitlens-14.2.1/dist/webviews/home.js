...
`;var ct=Object.defineProperty,at=Object.getOwnPropertyDescriptor,ht=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?at(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&ct(t,o,i),i};let lt=class extends Ye{constructor(){super(...arguments),this.full=!1,this.tabIndex=0}get role(){return this.href?"link":"button"}render(){const e=Le`<slot></slot>`;return null!=this.href?Le`<a href=${this.href}>${e}</a>`:e}};lt.styles=[st,Y`
		...
		`],ht([nt({type:Boolean,reflect:!0})],lt.prototype,"full",2),ht([nt()],lt.prototype,"href",2),ht([nt({reflect:!0})],lt.prototype,"role",1),ht([nt()],lt.prototype,"appearance",2),ht([nt({type:Number,reflect:!0})],lt.prototype,"tabIndex",2),lt=ht([tt("gl-button")],lt);var bt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,dt=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?ft(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&bt(t,o,i),i};let ut=class extends Ye{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};ut.styles=Y`
		:host {
