...
`;var ct=Object.defineProperty,at=Object.getOwnPropertyDescriptor,ht=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?at(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&ct(t,o,i),i};let bt=class extends Ye{constructor(){super(...arguments),this.full=!1,this.tabIndex=0}get role(){return this.href?"link":"button"}render(){const e=Le`<slot></slot>`;return null!=this.href?Le`<a href=${this.href}>${e}</a>`:e}};bt.styles=[st,Y`
			:host {
		...
		`],ht([nt({type:Boolean,reflect:!0})],bt.prototype,"full",2),ht([nt()],bt.prototype,"href",2),ht([nt({reflect:!0})],bt.prototype,"role",1),ht([nt()],bt.prototype,"appearance",2),ht([nt({type:Number,reflect:!0})],bt.prototype,"tabIndex",2),bt=ht([tt("gl-button")],bt);var lt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,dt=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?ft(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&lt(t,o,i),i};let ut=class extends Ye{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};ut.styles=Y`
		:host {
