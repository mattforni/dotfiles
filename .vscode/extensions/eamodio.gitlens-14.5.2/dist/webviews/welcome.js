...
`;var po=Object.defineProperty,fo=Object.getOwnPropertyDescriptor;let bo=class extends At{render(){return dt`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- a-prettier-ignore -->
		...
		`],bo=((e,t,o,n)=>{for(var s,r=n>1?void 0:n?fo(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&po(t,o,r),r})([Pt("gk-focus-svg")],bo);var uo=Object.defineProperty,go=Object.getOwnPropertyDescriptor;let yo=class extends At{render(){return dt`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- prettier-ignore -->
			<svg width="850" height="290" viewBox="0 0 850 290" fill="none" xmlns="http://www.w3.org/2000/svg">
