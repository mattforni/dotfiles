...
`;var Po=Object.defineProperty,Oo=Object.getOwnPropertyDescriptor,No=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?Oo(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&Po(t,o,r),r};let Lo=class extends lit_element_s{constructor(){super(...arguments),this.full=!1,this.disabled=!1}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return null!=this.href?Wt`<a class="control" part="base" tabindex="${!1===this.disabled?-1:0}" href=${this.href}
				><slot></slot
			></a>`:Wt`<button class="control" part="base" ?disabled=${this.disabled}><slot></slot></button>`}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};Lo.shadowRootOptions={...lit_element_s.shadowRootOptions,delegatesFocus:!0},Lo.styles=[To,tt`
			:host {
		...
		`],No([lo(".control")],Lo.prototype,"control",2),No([ro({type:Boolean,reflect:!0})],Lo.prototype,"full",2),No([ro({type:Boolean,reflect:!0})],Lo.prototype,"disabled",2),No([ro({reflect:!0})],Lo.prototype,"density",2),No([ro()],Lo.prototype,"href",2),No([ro({reflect:!0})],Lo.prototype,"role",1),No([ro()],Lo.prototype,"appearance",2),Lo=No([no("gl-button")],Lo);var zo=Object.defineProperty,Io=Object.getOwnPropertyDescriptor,Fo=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?Io(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&zo(t,o,r),r};let Uo=class extends lit_element_s{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};Uo.styles=tt`
		:host {
	...
	`,Fo([ro()],Uo.prototype,"icon",2),Fo([ro()],Uo.prototype,"modifier",2),Fo([ro({type:Number})],Uo.prototype,"size",2),Uo=Fo([no("code-icon")],Uo);const jo=[["year",629856e5,31536e6,"yr"],["month",2628e6,2628e6,"mo"],["week",6048e5,6048e5,"wk"],["day",864e5,864e5,"d"],["hour",36e5,36e5,"h"],["minute",6e4,6e4,"m"],["second",1e3,1e3,"s"]];let qo;let Vo,Wo,Go;function Yo(e,t){const o=("number"==typeof e?e:e.getTime())-(new Date).getTime();for(const[e,n,i,r]of jo){const a=Math.abs(o);if(a>=n||1e3===n){if(t){if(null==qo&&(null!=Go?qo=Go.resolvedOptions().locale:null!=Wo?qo=Wo.resolvedOptions().locale:(Go=new Intl.RelativeTimeFormat(Vo,{localeMatcher:"best fit",numeric:"always",style:"narrow"}),qo=Go.resolvedOptions().locale)),"en"===qo||qo?.startsWith("en-")){return`${Math.round(a/i)}${r}`}return null==Go&&(Go=new Intl.RelativeTimeFormat(Vo,{localeMatcher:"best fit",numeric:"always",style:"narrow"})),Go.format(Math.round(o/i),e)}return null==Wo&&(Wo=new Intl.RelativeTimeFormat(Vo,{localeMatcher:"best fit",numeric:"auto",style:"long"})),Wo.format(Math.round(o/i),e)}}return""}var Qo=(e=>(e[e.VerificationRequired=-1]="VerificationRequired",e[e.Free=0]="Free",e[e.FreeInPreviewTrial=1]="FreeInPreviewTrial",e[e.FreePreviewTrialExpired=2]="FreePreviewTrialExpired",e[e.FreePlusInTrial=3]="FreePlusInTrial",e[e.FreePlusTrialExpired=4]="FreePlusTrialExpired",e[e.FreePlusTrialReactivationEligible=5]="FreePlusTrialReactivationEligible",e[e.Paid=6]="Paid",e))(Qo||{});function Jo(e){switch(e){case"free+":return"GitKraken Free";case"pro":return"GitKraken Pro";case"teams":return"GitKraken Teams";case"enterprise":return"GitKraken Enterprise";default:return"GitKraken"}}function Ko(e,t){return Zo(e.plan.effective.expiresOn,t)}function Zo(e,t){return null!=e?function(e,t,o,n){const i=("number"==typeof t?t:t.getTime())-("number"==typeof e?e:e.getTime()),r=n??Math.floor;switch(o){case"days":return r(i/864e5);case"hours":return r(i/36e5);case"minutes":return r(i/6e4);case"seconds":return r(i/1e3);default:return i}}(Date.now(),new Date(e),t,Math.round):void 0}function Xo(e){return null!=e&&(6===e||1===e||3===e)}function en(e){return null!=e&&(1===e||3===e)}const tn=tt`
	a {
...
`;var on=Object.defineProperty,nn=Object.getOwnPropertyDescriptor,sn=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?nn(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&on(t,o,r),r};let rn=class extends lit_element_s{render(){if(null==this.state)return void(this.hidden=!0);this.hidden=!1;const e="alert"===(this.appearance??"alert")?"alert":Yt,t=new Date("2023-12-31T07:59:00.000Z").getTime(),o=Date.now()<t;switch(this.state){case Qo.VerificationRequired:return Wt`
				...
				`;case Qo.FreePreviewTrialExpired:return Wt`
				...
				`;case Qo.FreePlusTrialExpired:return Wt`
					...
					${So(o,(()=>Wt`<p style="text-align: center;">
								<a
								...
								/></a>
							</p>`),(()=>Wt`<p style="text-align: center;">
								Special: <b>50% off first seat of Pro</b> — only $4/month!<br />
							</p>`))}
				`;case Qo.FreePlusTrialReactivationEligible:return Wt`
		...
		`],sn([ro({type:String})],rn.prototype,"appearance",2),sn([ro({attribute:!1,type:Number})],rn.prototype,"state",2),rn=sn([no("gk-feature-gate-plus-state")],rn);var an=Object.defineProperty,cn=Object.getOwnPropertyDescriptor,ln=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?cn(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&an(t,o,r),r};let hn=class extends lit_element_s{render(){if(!this.visible||null!=this.state&&Xo(this.state))return void(this.hidden=!0);const e=this.appearance??"editor"===(document.body.getAttribute("data-placement")??"editor")?"alert":"welcome";return this.hidden=!1,Wt`
			<section>
				<slot></slot>
	...
	`,ln([ro({reflect:!0})],hn.prototype,"appearance",2),ln([ro({attribute:!1,type:Number})],hn.prototype,"state",2),ln([ro({type:Boolean})],hn.prototype,"visible",2),hn=ln([no("gk-feature-gate")],hn);const dn=function(){if("undefined"!=typeof globalThis)return globalThis;if("undefined"!=typeof global)return global;if("undefined"!=typeof self)return self;if("undefined"!=typeof window)return window;try{return new Function("return this")()}catch(e){return{}}}();void 0===dn.trustedTypes&&(dn.trustedTypes={createPolicy:(e,t)=>t});const un={configurable:!1,enumerable:!1,writable:!1};void 0===dn.FAST&&Reflect.defineProperty(dn,"FAST",Object.assign({value:Object.create(null)},un));const pn=dn.FAST;if(void 0===pn.getById){const e=Object.create(null);Reflect.defineProperty(pn,"getById",Object.assign({value(t,o){let n=e[t];return void 0===n&&(n=o?e[t]=o():null),n}},un))}const fn=Object.freeze([]);function bn(){const e=new WeakMap;return function(t){let o=e.get(t);if(void 0===o){let n=Reflect.getPrototypeOf(t);for(;void 0===o&&null!==n;)o=e.get(n),n=Reflect.getPrototypeOf(n);o=void 0===o?[]:o.slice(0),e.set(t,o)}return o}}const gn=dn.FAST.getById(1,(()=>{const e=[],t=[];function o(){if(t.length)throw t.shift()}function n(e){try{e.call()}catch(e){t.push(e),setTimeout(o,0)}}function i(){let t=0;for(;t<e.length;)if(n(e[t]),t++,t>1024){for(let o=0,n=e.length-t;o<n;o++)e[o]=e[o+t];e.length-=t,t=0}e.length=0}return Object.freeze({enqueue:function(t){e.length<1&&dn.requestAnimationFrame(i),e.push(t)},process:i})})),mn=dn.trustedTypes.createPolicy("fast-html",{createHTML:e=>e});let vn=mn;const yn=`fast-${Math.random().toString(36).substring(2,8)}`,wn=`${yn}{`,_n=`}${yn}`,kn=Object.freeze({supportsAdoptedStyleSheets:Array.isArray(document.adoptedStyleSheets)&&"replace"in CSSStyleSheet.prototype,setHTMLPolicy(e){if(vn!==mn)throw new Error("The HTML policy can only be set once.");vn=e},createHTML:e=>vn.createHTML(e),isMarker:e=>e&&8===e.nodeType&&e.data.startsWith(yn),extractDirectiveIndexFromMarker:e=>parseInt(e.data.replace(`${yn}:`,"")),createInterpolationPlaceholder:e=>`${wn}${e}${_n}`,createCustomAttributePlaceholder(e,t){return`${e}="${this.createInterpolationPlaceholder(t)}"`},createBlockPlaceholder:e=>`\x3c!--${yn}:${e}--\x3e`,queueUpdate:gn.enqueue,processUpdates:gn.process,nextUpdate:()=>new Promise(gn.enqueue),setAttribute(e,t,o){null==o?e.removeAttribute(t):e.setAttribute(t,o)},setBooleanAttribute(e,t,o){o?e.setAttribute(t,""):e.removeAttribute(t)},removeChildNodes(e){for(let t=e.firstChild;null!==t;t=e.firstChild)e.removeChild(t)},createTemplateWalker:e=>document.createTreeWalker(e,133,null,!1)});class SubscriberSet{constructor(e,t){this.sub1=void 0,this.sub2=void 0,this.spillover=void 0,this.source=e,this.sub1=t}has(e){return void 0===this.spillover?this.sub1===e||this.sub2===e:-1!==this.spillover.indexOf(e)}subscribe(e){const t=this.spillover;if(void 0===t){if(this.has(e))return;if(void 0===this.sub1)return void(this.sub1=e);if(void 0===this.sub2)return void(this.sub2=e);this.spillover=[this.sub1,this.sub2,e],this.sub1=void 0,this.sub2=void 0}else{-1===t.indexOf(e)&&t.push(e)}}unsubscribe(e){const t=this.spillover;if(void 0===t)this.sub1===e?this.sub1=void 0:this.sub2===e&&(this.sub2=void 0);else{const o=t.indexOf(e);-1!==o&&t.splice(o,1)}}notify(e){const t=this.spillover,o=this.source;if(void 0===t){const t=this.sub1,n=this.sub2;void 0!==t&&t.handleChange(o,e),void 0!==n&&n.handleChange(o,e)}else for(let n=0,i=t.length;n<i;++n)t[n].handleChange(o,e)}}class PropertyChangeNotifier{constructor(e){this.subscribers={},this.sourceSubscribers=null,this.source=e}notify(e){var t;const o=this.subscribers[e];void 0!==o&&o.notify(e),null===(t=this.sourceSubscribers)||void 0===t||t.notify(e)}subscribe(e,t){var o;if(t){let o=this.subscribers[t];void 0===o&&(this.subscribers[t]=o=new SubscriberSet(this.source)),o.subscribe(e)}else this.sourceSubscribers=null!==(o=this.sourceSubscribers)&&void 0!==o?o:new SubscriberSet(this.source),this.sourceSubscribers.subscribe(e)}unsubscribe(e,t){var o;if(t){const o=this.subscribers[t];void 0!==o&&o.unsubscribe(e)}else null===(o=this.sourceSubscribers)||void 0===o||o.unsubscribe(e)}}const $n=pn.getById(2,(()=>{const e=/(:|&&|\|\||if)/,t=new WeakMap,o=kn.queueUpdate;let n,i=e=>{throw new Error("Must call enableArrayObservation before observing arrays.")};function r(e){let o=e.$fastController||t.get(e);return void 0===o&&(Array.isArray(e)?o=i(e):t.set(e,o=new PropertyChangeNotifier(e))),o}const a=bn();class DefaultObservableAccessor{constructor(e){this.name=e,this.field=`_${e}`,this.callback=`${e}Changed`}getValue(e){return void 0!==n&&n.watch(e,this.name),e[this.field]}setValue(e,t){const o=this.field,n=e[o];if(n!==t){e[o]=t;const i=e[this.callback];"function"==typeof i&&i.call(e,n,t),r(e).notify(this.name)}}}class BindingObserverImplementation extends SubscriberSet{constructor(e,t,o=!1){super(e,t),this.binding=e,this.isVolatileBinding=o,this.needsRefresh=!0,this.needsQueue=!0,this.first=this,this.last=null,this.propertySource=void 0,this.propertyName=void 0,this.notifier=void 0,this.next=void 0}observe(e,t){this.needsRefresh&&null!==this.last&&this.disconnect();const o=n;n=this.needsRefresh?this:void 0,this.needsRefresh=this.isVolatileBinding;const i=this.binding(e,t);return n=o,i}disconnect(){if(null!==this.last){let e=this.first;for(;void 0!==e;)e.notifier.unsubscribe(this,e.propertyName),e=e.next;this.last=null,this.needsRefresh=this.needsQueue=!0}}watch(e,t){const o=this.last,i=r(e),a=null===o?this.first:{};if(a.propertySource=e,a.propertyName=t,a.notifier=i,i.subscribe(this,t),null!==o){if(!this.needsRefresh){let t;n=void 0,t=o.propertySource[o.propertyName],n=this,e===t&&(this.needsRefresh=!0)}o.next=a}this.last=a}handleChange(){this.needsQueue&&(this.needsQueue=!1,o(this))}call(){null!==this.last&&(this.needsQueue=!0,this.notify(this))}records(){let e=this.first;return{next:()=>{const t=e;return void 0===t?{value:void 0,done:!0}:(e=e.next,{value:t,done:!1})},[Symbol.iterator]:function(){return this}}}}return Object.freeze({setArrayObserverFactory(e){i=e},getNotifier:r,track(e,t){void 0!==n&&n.watch(e,t)},trackVolatile(){void 0!==n&&(n.needsRefresh=!0)},notify(e,t){r(e).notify(t)},defineProperty(e,t){"string"==typeof t&&(t=new DefaultObservableAccessor(t)),a(e).push(t),Reflect.defineProperty(e,t.name,{enumerable:!0,get:function(){return t.getValue(this)},set:function(e){t.setValue(this,e)}})},getAccessors:a,binding(e,t,o=this.isVolatileBinding(e)){return new BindingObserverImplementation(e,t,o)},isVolatileBinding:t=>e.test(t.toString())})}));function xn(e,t){$n.defineProperty(e,t)}function An(e,t,o){return Object.assign({},o,{get:function(){return $n.trackVolatile(),o.get.apply(this)}})}const Sn=pn.getById(3,(()=>{let e=null;return{get:()=>e,set(t){e=t}}}));class ExecutionContext{constructor(){this.index=0,this.length=0,this.parent=null,this.parentContext=null}get event(){return Sn.get()}get isEven(){return this.index%2==0}get isOdd(){return this.index%2!=0}get isFirst(){return 0===this.index}get isInMiddle(){return!this.isFirst&&!this.isLast}get isLast(){return this.index===this.length-1}static setEvent(e){Sn.set(e)}}$n.defineProperty(ExecutionContext.prototype,"index"),$n.defineProperty(ExecutionContext.prototype,"length");const Cn=Object.seal(new ExecutionContext);class HTMLDirective{constructor(){this.targetIndex=0}}class TargetedHTMLDirective extends HTMLDirective{constructor(){super(...arguments),this.createPlaceholder=kn.createInterpolationPlaceholder}}class AttachedBehaviorHTMLDirective extends HTMLDirective{constructor(e,t,o){super(),this.name=e,this.behavior=t,this.options=o}createPlaceholder(e){return kn.createCustomAttributePlaceholder(this.name,e)}createBehavior(e){return new this.behavior(e,this.options)}}function En(e,t){this.source=e,this.context=t,null===this.bindingObserver&&(this.bindingObserver=$n.binding(this.binding,this,this.isBindingVolatile)),this.updateTarget(this.bindingObserver.observe(e,t))}function Tn(e,t){this.source=e,this.context=t,this.target.addEventListener(this.targetName,this)}function Pn(){this.bindingObserver.disconnect(),this.source=null,this.context=null}function Rn(){this.bindingObserver.disconnect(),this.source=null,this.context=null;const e=this.target.$fastView;void 0!==e&&e.isComposed&&(e.unbind(),e.needsBindOnly=!0)}function On(){this.target.removeEventListener(this.targetName,this),this.source=null,this.context=null}function Mn(e){kn.setAttribute(this.target,this.targetName,e)}function Bn(e){kn.setBooleanAttribute(this.target,this.targetName,e)}function Nn(e){if(null==e&&(e=""),e.create){this.target.textContent="";let t=this.target.$fastView;void 0===t?t=e.create():this.target.$fastTemplate!==e&&(t.isComposed&&(t.remove(),t.unbind()),t=e.create()),t.isComposed?t.needsBindOnly&&(t.needsBindOnly=!1,t.bind(this.source,this.context)):(t.isComposed=!0,t.bind(this.source,this.context),t.insertBefore(this.target),this.target.$fastView=t,this.target.$fastTemplate=e)}else{const t=this.target.$fastView;void 0!==t&&t.isComposed&&(t.isComposed=!1,t.remove(),t.needsBindOnly?t.needsBindOnly=!1:t.unbind()),this.target.textContent=e}}function Dn(e){this.target[this.targetName]=e}function Ln(e){const t=this.classVersions||Object.create(null),o=this.target;let n=this.version||0;if(null!=e&&e.length){const i=e.split(/\s+/);for(let e=0,r=i.length;e<r;++e){const r=i[e];""!==r&&(t[r]=n,o.classList.add(r))}}if(this.classVersions=t,this.version=n+1,0!==n){n-=1;for(const e in t)t[e]===n&&o.classList.remove(e)}}class HTMLBindingDirective extends TargetedHTMLDirective{constructor(e){super(),this.binding=e,this.bind=En,this.unbind=Pn,this.updateTarget=Mn,this.isBindingVolatile=$n.isVolatileBinding(this.binding)}get targetName(){return this.originalTargetName}set targetName(e){if(this.originalTargetName=e,void 0!==e)switch(e[0]){case":":if(this.cleanedTargetName=e.substr(1),this.updateTarget=Dn,"innerHTML"===this.cleanedTargetName){const e=this.binding;this.binding=(t,o)=>kn.createHTML(e(t,o))}break;case"?":this.cleanedTargetName=e.substr(1),this.updateTarget=Bn;break;case"@":this.cleanedTargetName=e.substr(1),this.bind=Tn,this.unbind=On;break;default:this.cleanedTargetName=e,"class"===e&&(this.updateTarget=Ln)}}targetAtContent(){this.updateTarget=Nn,this.unbind=Rn}createBehavior(e){return new BindingBehavior(e,this.binding,this.isBindingVolatile,this.bind,this.unbind,this.updateTarget,this.cleanedTargetName)}}class BindingBehavior{constructor(e,t,o,n,i,r,a){this.source=null,this.context=null,this.bindingObserver=null,this.target=e,this.binding=t,this.isBindingVolatile=o,this.bind=n,this.unbind=i,this.updateTarget=r,this.targetName=a}handleChange(){this.updateTarget(this.bindingObserver.observe(this.source,this.context))}handleEvent(e){ExecutionContext.setEvent(e);const t=this.binding(this.source,this.context);ExecutionContext.setEvent(null),!0!==t&&e.preventDefault()}}let zn=null;class CompilationContext{addFactory(e){e.targetIndex=this.targetIndex,this.behaviorFactories.push(e)}captureContentBinding(e){e.targetAtContent(),this.addFactory(e)}reset(){this.behaviorFactories=[],this.targetIndex=-1}release(){zn=this}static borrow(e){const t=zn||new CompilationContext;return t.directives=e,t.reset(),zn=null,t}}function In(e){if(1===e.length)return e[0];let t;const o=e.length,n=e.map((e=>"string"==typeof e?()=>e:(t=e.targetName||t,e.binding))),i=new HTMLBindingDirective(((e,t)=>{let i="";for(let r=0;r<o;++r)i+=n[r](e,t);return i}));return i.targetName=t,i}const Hn=_n.length;function Fn(e,t){const o=t.split(wn);if(1===o.length)return null;const n=[];for(let t=0,i=o.length;t<i;++t){const i=o[t],r=i.indexOf(_n);let a;if(-1===r)a=i;else{const t=parseInt(i.substring(0,r));n.push(e.directives[t]),a=i.substring(r+Hn)}""!==a&&n.push(a)}return n}function Un(e,t,o=!1){const n=t.attributes;for(let i=0,r=n.length;i<r;++i){const a=n[i],c=a.value,l=Fn(e,c);let h=null;null===l?o&&(h=new HTMLBindingDirective((()=>c)),h.targetName=a.name):h=In(l),null!==h&&(t.removeAttributeNode(a),i--,r--,e.addFactory(h))}}function jn(e,t,o){const n=Fn(e,t.textContent);if(null!==n){let i=t;for(let r=0,a=n.length;r<a;++r){const a=n[r],c=0===r?t:i.parentNode.insertBefore(document.createTextNode(""),i.nextSibling);"string"==typeof a?c.textContent=a:(c.textContent=" ",e.captureContentBinding(a)),i=c,e.targetIndex++,c!==t&&o.nextNode()}e.targetIndex--}}const qn=document.createRange();class HTMLView{constructor(e,t){this.fragment=e,this.behaviors=t,this.source=null,this.context=null,this.firstChild=e.firstChild,this.lastChild=e.lastChild}appendTo(e){e.appendChild(this.fragment)}insertBefore(e){if(this.fragment.hasChildNodes())e.parentNode.insertBefore(this.fragment,e);else{const t=this.lastChild;if(e.previousSibling===t)return;const o=e.parentNode;let n,i=this.firstChild;for(;i!==t;)n=i.nextSibling,o.insertBefore(i,e),i=n;o.insertBefore(t,e)}}remove(){const e=this.fragment,t=this.lastChild;let o,n=this.firstChild;for(;n!==t;)o=n.nextSibling,e.appendChild(n),n=o;e.appendChild(t)}dispose(){const e=this.firstChild.parentNode,t=this.lastChild;let o,n=this.firstChild;for(;n!==t;)o=n.nextSibling,e.removeChild(n),n=o;e.removeChild(t);const i=this.behaviors,r=this.source;for(let e=0,t=i.length;e<t;++e)i[e].unbind(r)}bind(e,t){const o=this.behaviors;if(this.source!==e)if(null!==this.source){const n=this.source;this.source=e,this.context=t;for(let i=0,r=o.length;i<r;++i){const r=o[i];r.unbind(n),r.bind(e,t)}}else{this.source=e,this.context=t;for(let n=0,i=o.length;n<i;++n)o[n].bind(e,t)}}unbind(){if(null===this.source)return;const e=this.behaviors,t=this.source;for(let o=0,n=e.length;o<n;++o)e[o].unbind(t);this.source=null}static disposeContiguousBatch(e){if(0!==e.length){qn.setStartBefore(e[0].firstChild),qn.setEndAfter(e[e.length-1].lastChild),qn.deleteContents();for(let t=0,o=e.length;t<o;++t){const o=e[t],n=o.behaviors,i=o.source;for(let e=0,t=n.length;e<t;++e)n[e].unbind(i)}}}}class ViewTemplate{constructor(e,t){this.behaviorCount=0,this.hasHostBehaviors=!1,this.fragment=null,this.targetOffset=0,this.viewBehaviorFactories=null,this.hostBehaviorFactories=null,this.html=e,this.directives=t}create(e){if(null===this.fragment){let e;const t=this.html;if("string"==typeof t){e=document.createElement("template"),e.innerHTML=kn.createHTML(t);const o=e.content.firstElementChild;null!==o&&"TEMPLATE"===o.tagName&&(e=o)}else e=t;const o=function(e,t){const o=e.content;document.adoptNode(o);const n=CompilationContext.borrow(t);Un(n,e,!0);const i=n.behaviorFactories;n.reset();const r=kn.createTemplateWalker(o);let a;for(;a=r.nextNode();)switch(n.targetIndex++,a.nodeType){case 1:Un(n,a);break;case 3:jn(n,a,r);break;case 8:kn.isMarker(a)&&n.addFactory(t[kn.extractDirectiveIndexFromMarker(a)])}let c=0;(kn.isMarker(o.firstChild)||1===o.childNodes.length&&t.length)&&(o.insertBefore(document.createComment(""),o.firstChild),c=-1);const l=n.behaviorFactories;return n.release(),{fragment:o,viewBehaviorFactories:l,hostBehaviorFactories:i,targetOffset:c}}(e,this.directives);this.fragment=o.fragment,this.viewBehaviorFactories=o.viewBehaviorFactories,this.hostBehaviorFactories=o.hostBehaviorFactories,this.targetOffset=o.targetOffset,this.behaviorCount=this.viewBehaviorFactories.length+this.hostBehaviorFactories.length,this.hasHostBehaviors=this.hostBehaviorFactories.length>0}const t=this.fragment.cloneNode(!0),o=this.viewBehaviorFactories,n=new Array(this.behaviorCount),i=kn.createTemplateWalker(t);let r=0,a=this.targetOffset,c=i.nextNode();for(let e=o.length;r<e;++r){const e=o[r],t=e.targetIndex;for(;null!==c;){if(a===t){n[r]=e.createBehavior(c);break}c=i.nextNode(),a++}}if(this.hasHostBehaviors){const t=this.hostBehaviorFactories;for(let o=0,i=t.length;o<i;++o,++r)n[r]=t[o].createBehavior(e)}return new HTMLView(t,n)}render(e,t,o){"string"==typeof t&&(t=document.getElementById(t)),void 0===o&&(o=t);const n=this.create(o);return n.bind(e,Cn),n.appendTo(t),n}}const Vn=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function Wn(e,...t){const o=[];let n="";for(let i=0,r=e.length-1;i<r;++i){const r=e[i];let a=t[i];if(n+=r,a instanceof ViewTemplate){const e=a;a=()=>e}if("function"==typeof a&&(a=new HTMLBindingDirective(a)),a instanceof TargetedHTMLDirective){const e=Vn.exec(r);null!==e&&(a.targetName=e[2])}a instanceof HTMLDirective?(n+=a.createPlaceholder(o.length),o.push(a)):n+=a}return n+=e[e.length-1],new ViewTemplate(n,o)}class NodeObservationBehavior{constructor(e,t){this.target=e,this.options=t,this.source=null}bind(e){const t=this.options.property;this.shouldUpdate=$n.getAccessors(e).some((e=>e.name===t)),this.source=e,this.updateTarget(this.computeNodes()),this.shouldUpdate&&this.observe()}unbind(){this.updateTarget(fn),this.source=null,this.shouldUpdate&&this.disconnect()}handleEvent(){this.updateTarget(this.computeNodes())}computeNodes(){let e=this.getNodes();return void 0!==this.options.filter&&(e=e.filter(this.options.filter)),e}updateTarget(e){this.source[this.options.property]=e}}class SlottedBehavior extends NodeObservationBehavior{constructor(e,t){super(e,t)}observe(){this.target.addEventListener("slotchange",this)}disconnect(){this.target.removeEventListener("slotchange",this)}getNodes(){return this.target.assignedNodes(this.options)}}function Gn(e){return"string"==typeof e&&(e={property:e}),new AttachedBehaviorHTMLDirective("fast-slotted",SlottedBehavior,e)}const Yn=e=>"function"==typeof e,Qn=()=>null;function Jn(e){return void 0===e?Qn:Yn(e)?e:()=>e}class CSSDirective{createCSS(){return""}createBehavior(){}}class ElementStyles{constructor(){this.targets=new WeakSet}addStylesTo(e){this.targets.add(e)}removeStylesFrom(e){this.targets.delete(e)}isAttachedTo(e){return this.targets.has(e)}withBehaviors(...e){return this.behaviors=null===this.behaviors?e:this.behaviors.concat(e),this}}function Kn(e){return e.map((e=>e instanceof ElementStyles?Kn(e.styles):[e])).reduce(((e,t)=>e.concat(t)),[])}function Zn(e){return e.map((e=>e instanceof ElementStyles?e.behaviors:null)).reduce(((e,t)=>null===t?e:(null===e&&(e=[]),e.concat(t))),null)}ElementStyles.create=(()=>{if(kn.supportsAdoptedStyleSheets){const e=new Map;return t=>new AdoptedStyleSheetsStyles(t,e)}return e=>new StyleElementStyles(e)})();let Xn=(e,t)=>{e.adoptedStyleSheets=[...e.adoptedStyleSheets,...t]},ei=(e,t)=>{e.adoptedStyleSheets=e.adoptedStyleSheets.filter((e=>-1===t.indexOf(e)))};if(kn.supportsAdoptedStyleSheets)try{document.adoptedStyleSheets.push(),document.adoptedStyleSheets.splice(),Xn=(e,t)=>{e.adoptedStyleSheets.push(...t)},ei=(e,t)=>{for(const o of t){const t=e.adoptedStyleSheets.indexOf(o);-1!==t&&e.adoptedStyleSheets.splice(t,1)}}}catch(Ae){}class AdoptedStyleSheetsStyles extends ElementStyles{constructor(e,t){super(),this.styles=e,this.styleSheetCache=t,this._styleSheets=void 0,this.behaviors=Zn(e)}get styleSheets(){if(void 0===this._styleSheets){const e=this.styles,t=this.styleSheetCache;this._styleSheets=Kn(e).map((e=>{if(e instanceof CSSStyleSheet)return e;let o=t.get(e);return void 0===o&&(o=new CSSStyleSheet,o.replaceSync(e),t.set(e,o)),o}))}return this._styleSheets}addStylesTo(e){Xn(e,this.styleSheets),super.addStylesTo(e)}removeStylesFrom(e){ei(e,this.styleSheets),super.removeStylesFrom(e)}}let ti=0;class StyleElementStyles extends ElementStyles{constructor(e){super(),this.styles=e,this.behaviors=null,this.behaviors=Zn(e),this.styleSheets=Kn(e),this.styleClass="fast-style-class-"+ ++ti}addStylesTo(e){const t=this.styleSheets,o=this.styleClass;e=this.normalizeTarget(e);for(let n=0;n<t.length;n++){const i=document.createElement("style");i.innerHTML=t[n],i.className=o,e.append(i)}super.addStylesTo(e)}removeStylesFrom(e){const t=(e=this.normalizeTarget(e)).querySelectorAll(`.${this.styleClass}`);for(let o=0,n=t.length;o<n;++o)e.removeChild(t[o]);super.removeStylesFrom(e)}isAttachedTo(e){return super.isAttachedTo(this.normalizeTarget(e))}normalizeTarget(e){return e===document?document.body:e}}function oi(e,t){const o=[];let n="";const i=[];for(let r=0,a=e.length-1;r<a;++r){n+=e[r];let a=t[r];if(a instanceof CSSDirective){const e=a.createBehavior();a=a.createCSS(),e&&i.push(e)}a instanceof ElementStyles||a instanceof CSSStyleSheet?(""!==n.trim()&&(o.push(n),n=""),o.push(a)):n+=a}return n+=e[e.length-1],""!==n.trim()&&o.push(n),{styles:o,behaviors:i}}function ni(e,...t){const{styles:o,behaviors:n}=oi(e,t),i=ElementStyles.create(o);return n.length&&i.withBehaviors(...n),i}const ii=Object.freeze({locate:bn()}),si={toView:e=>e?"true":"false",fromView:e=>null!=e&&"false"!==e&&!1!==e&&0!==e};class AttributeDefinition{constructor(e,t,o=t.toLowerCase(),n="reflect",i){this.guards=new Set,this.Owner=e,this.name=t,this.attribute=o,this.mode=n,this.converter=i,this.fieldName=`_${t}`,this.callbackName=`${t}Changed`,this.hasCallback=this.callbackName in e.prototype,"boolean"===n&&void 0===i&&(this.converter=si)}setValue(e,t){const o=e[this.fieldName],n=this.converter;void 0!==n&&(t=n.fromView(t)),o!==t&&(e[this.fieldName]=t,this.tryReflectToAttribute(e),this.hasCallback&&e[this.callbackName](o,t),e.$fastController.notify(this.name))}getValue(e){return $n.track(e,this.name),e[this.fieldName]}onAttributeChangedCallback(e,t){this.guards.has(e)||(this.guards.add(e),this.setValue(e,t),this.guards.delete(e))}tryReflectToAttribute(e){const t=this.mode,o=this.guards;o.has(e)||"fromView"===t||kn.queueUpdate((()=>{o.add(e);const n=e[this.fieldName];switch(t){case"reflect":const t=this.converter;kn.setAttribute(e,this.attribute,void 0!==t?t.toView(n):n);break;case"boolean":kn.setBooleanAttribute(e,this.attribute,n)}o.delete(e)}))}static collect(e,...t){const o=[];t.push(ii.locate(e));for(let n=0,i=t.length;n<i;++n){const i=t[n];if(void 0!==i)for(let t=0,n=i.length;t<n;++t){const n=i[t];"string"==typeof n?o.push(new AttributeDefinition(e,n)):o.push(new AttributeDefinition(e,n.property,n.attribute,n.mode,n.converter))}}return o}}function ri(e,t){let o;function n(e,t){arguments.length>1&&(o.property=t),ii.locate(e.constructor).push(o)}return arguments.length>1?(o={},void n(e,t)):(o=void 0===e?{}:e,n)}const ai={mode:"open"},ci={},li=pn.getById(4,(()=>{const e=new Map;return Object.freeze({register:t=>!e.has(t.type)&&(e.set(t.type,t),!0),getByType:t=>e.get(t)})}));class FASTElementDefinition{constructor(e,t=e.definition){"string"==typeof t&&(t={name:t}),this.type=e,this.name=t.name,this.template=t.template;const o=AttributeDefinition.collect(e,t.attributes),n=new Array(o.length),i={},r={};for(let e=0,t=o.length;e<t;++e){const t=o[e];n[e]=t.attribute,i[t.name]=t,r[t.attribute]=t}this.attributes=o,this.observedAttributes=n,this.propertyLookup=i,this.attributeLookup=r,this.shadowOptions=void 0===t.shadowOptions?ai:null===t.shadowOptions?void 0:Object.assign(Object.assign({},ai),t.shadowOptions),this.elementOptions=void 0===t.elementOptions?ci:Object.assign(Object.assign({},ci),t.elementOptions),this.styles=void 0===t.styles?void 0:Array.isArray(t.styles)?ElementStyles.create(t.styles):t.styles instanceof ElementStyles?t.styles:ElementStyles.create([t.styles])}get isDefined(){return!!li.getByType(this.type)}define(e=customElements){const t=this.type;if(li.register(this)){const e=this.attributes,o=t.prototype;for(let t=0,n=e.length;t<n;++t)$n.defineProperty(o,e[t]);Reflect.defineProperty(t,"observedAttributes",{value:this.observedAttributes,enumerable:!0})}return e.get(this.name)||e.define(this.name,t,this.elementOptions),this}}FASTElementDefinition.forType=li.getByType;const hi=new WeakMap,di={bubbles:!0,composed:!0,cancelable:!0};function ui(e){return e.shadowRoot||hi.get(e)||null}class Controller extends PropertyChangeNotifier{constructor(e,t){super(e),this.boundObservables=null,this.behaviors=null,this.needsInitialization=!0,this._template=null,this._styles=null,this._isConnected=!1,this.$fastController=this,this.view=null,this.element=e,this.definition=t;const o=t.shadowOptions;if(void 0!==o){const t=e.attachShadow(o);"closed"===o.mode&&hi.set(e,t)}const n=$n.getAccessors(e);if(n.length>0){const t=this.boundObservables=Object.create(null);for(let o=0,i=n.length;o<i;++o){const i=n[o].name,r=e[i];void 0!==r&&(delete e[i],t[i]=r)}}}get isConnected(){return $n.track(this,"isConnected"),this._isConnected}setIsConnected(e){this._isConnected=e,$n.notify(this,"isConnected")}get template(){return this._template}set template(e){this._template!==e&&(this._template=e,this.needsInitialization||this.renderTemplate(e))}get styles(){return this._styles}set styles(e){this._styles!==e&&(null!==this._styles&&this.removeStyles(this._styles),this._styles=e,this.needsInitialization||null===e||this.addStyles(e))}addStyles(e){const t=ui(this.element)||this.element.getRootNode();if(e instanceof HTMLStyleElement)t.append(e);else if(!e.isAttachedTo(t)){const o=e.behaviors;e.addStylesTo(t),null!==o&&this.addBehaviors(o)}}removeStyles(e){const t=ui(this.element)||this.element.getRootNode();if(e instanceof HTMLStyleElement)t.removeChild(e);else if(e.isAttachedTo(t)){const o=e.behaviors;e.removeStylesFrom(t),null!==o&&this.removeBehaviors(o)}}addBehaviors(e){const t=this.behaviors||(this.behaviors=new Map),o=e.length,n=[];for(let i=0;i<o;++i){const o=e[i];t.has(o)?t.set(o,t.get(o)+1):(t.set(o,1),n.push(o))}if(this._isConnected){const e=this.element;for(let t=0;t<n.length;++t)n[t].bind(e,Cn)}}removeBehaviors(e,t=!1){const o=this.behaviors;if(null===o)return;const n=e.length,i=[];for(let r=0;r<n;++r){const n=e[r];if(o.has(n)){const e=o.get(n)-1;0===e||t?o.delete(n)&&i.push(n):o.set(n,e)}}if(this._isConnected){const e=this.element;for(let t=0;t<i.length;++t)i[t].unbind(e)}}onConnectedCallback(){if(this._isConnected)return;const e=this.element;this.needsInitialization?this.finishInitialization():null!==this.view&&this.view.bind(e,Cn);const t=this.behaviors;if(null!==t)for(const[o]of t)o.bind(e,Cn);this.setIsConnected(!0)}onDisconnectedCallback(){if(!this._isConnected)return;this.setIsConnected(!1);const e=this.view;null!==e&&e.unbind();const t=this.behaviors;if(null!==t){const e=this.element;for(const[o]of t)o.unbind(e)}}onAttributeChangedCallback(e,t,o){const n=this.definition.attributeLookup[e];void 0!==n&&n.onAttributeChangedCallback(this.element,o)}emit(e,t,o){return!!this._isConnected&&this.element.dispatchEvent(new CustomEvent(e,Object.assign(Object.assign({detail:t},di),o)))}finishInitialization(){const e=this.element,t=this.boundObservables;if(null!==t){const o=Object.keys(t);for(let n=0,i=o.length;n<i;++n){const i=o[n];e[i]=t[i]}this.boundObservables=null}const o=this.definition;null===this._template&&(this.element.resolveTemplate?this._template=this.element.resolveTemplate():o.template&&(this._template=o.template||null)),null!==this._template&&this.renderTemplate(this._template),null===this._styles&&(this.element.resolveStyles?this._styles=this.element.resolveStyles():o.styles&&(this._styles=o.styles||null)),null!==this._styles&&this.addStyles(this._styles),this.needsInitialization=!1}renderTemplate(e){const t=this.element,o=ui(t)||t;null!==this.view?(this.view.dispose(),this.view=null):this.needsInitialization||kn.removeChildNodes(o),e&&(this.view=e.render(t,o,t))}static forCustomElement(e){const t=e.$fastController;if(void 0!==t)return t;const o=FASTElementDefinition.forType(e.constructor);if(void 0===o)throw new Error("Missing FASTElement definition.");return e.$fastController=new Controller(e,o)}}function pi(e){return class extends e{constructor(){super(),Controller.forCustomElement(this)}$emit(e,t,o){return this.$fastController.emit(e,t,o)}connectedCallback(){this.$fastController.onConnectedCallback()}disconnectedCallback(){this.$fastController.onDisconnectedCallback()}attributeChangedCallback(e,t,o){this.$fastController.onAttributeChangedCallback(e,t,o)}}}const fi=Object.assign(pi(HTMLElement),{from:e=>pi(e),define:(e,t)=>new FASTElementDefinition(e,t).define().type});function bi(...e){return e.some((e=>(e?.length??0)>0))}const gi=ni`
	:host {
		box-sizing: border-box;
	}
	:host *,
...
`;var mi=Object.defineProperty,vi=Object.getOwnPropertyDescriptor,yi=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?vi(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&mi(t,o,r),r};const wi=Wn`
	<template>
		...
		${function(e,t,o){const n=Yn(e)?e:()=>e,i=Jn(t),r=Jn(o);return(e,t)=>n(e,t)?i(e,t):r(e,t)}((e=>e.caret),Wn`<span class="caret"></span>`)}
	</template>
`,_i=ni`
	${gi}
...
`;let ki=class extends fi{constructor(){super(...arguments),this.open=!1,this.caret=!0}get hasTopNodes(){return bi(this.typeNodes,this.actionsNodes)}get hasHeadingNodes(){return bi(this.headingNodes)}};var $i;yi([ri({mode:"boolean"})],ki.prototype,"open",2),yi([ri({mode:"boolean"})],ki.prototype,"caret",2),yi([ri],ki.prototype,"placement",2),yi([xn],ki.prototype,"typeNodes",2),yi([xn],ki.prototype,"actionsNodes",2),yi([xn],ki.prototype,"headingNodes",2),yi([An],ki.prototype,"hasTopNodes",1),yi([An],ki.prototype,"hasHeadingNodes",1),ki=yi([($i={name:"pop-over",template:wi,styles:_i},function(e){new FASTElementDefinition(e,$i).define()})],ki);var xi=Object.defineProperty,Ai=Object.getOwnPropertyDescriptor,Si=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?Ai(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&xi(t,o,r),r};let Ci=class extends lit_element_s{constructor(){super(...arguments),this.placement="top end"}render(){const e=Xo(this.subscription?.state),t=en(this.subscription?.state);return Wt`
			<span class="badge-container">
				<span class="badge ${e?"active":"inactive"}"
					>${t?Wt`<span class="badge-trial">Trial</span>`:""}✨</span
				>
				<pop-over .placement=${this.placement} class="badge-popover">
					<span slot="heading"
						>${function(e,t){switch(e){case 4:case 5:return Jo("free+");case 1:return`${Jo("pro")} (Trial)`;case 3:return`${Jo(t??"pro")} (Trial)`;case-1:return"GitKraken (Unverified)";case 6:return Jo(t??"pro");default:return"GitKraken"}}(this.subscription?.state,this.subscription?.plan.effective.id)}${this.trialHtml}</span
					>
					${this.footnoteHtml}
				</pop-over>
			</span>
		`}get trialHtml(){if(!en(this.subscription?.state))return Yt;const e=Ko(this.subscription,"days")??0;return Wt`<span class="badge-trial-left">${e<1?"<1 day":function(e,t,o){if(null==o)return`${t} ${e}${1===t?"":"s"}`;const n=1===t?e:o.plural??`${e}s`;return o.only?n:`${0===t?o.zero??t:o.format?.(t)??t}${o.infix??" "}${n}`}("day",e)} left</span>`}get footnoteHtml(){switch(this.subscription?.state){case Qo.VerificationRequired:case Qo.Free:case Qo.FreePreviewTrialExpired:return Wt`<span class="badge-footnote"
					>✨ Requires a trial or paid plan for use on privately hosted repos.</span
				>`;case Qo.FreePlusTrialExpired:case Qo.FreeInPreviewTrial:case Qo.FreePlusInTrial:case Qo.FreePlusTrialReactivationEligible:return Wt`<span class="badge-footnote"
					>✨ Requires a paid plan for use on privately hosted repos.</span
				>`;case Qo.Paid:return Wt`<span class="badge-footnote"
					>You have access to ✨ features on privately hosted repos and ☁️ features based on your plan.</span
				>`;default:return Yt}}};Ci.styles=[To,tt`
			:host {
				position: relative;
			}
		...
		`],Si([ro({reflect:!0})],Ci.prototype,"placement",2),Si([ro({attribute:!1})],Ci.prototype,"subscription",2),Ci=Si([no("gk-feature-gate-badge")],Ci);const Ei=tt`
	.repo-branch {
		display: flex;
		flex-direction: column;
		gap: 0 0.4rem;
...
`;function Oi(e,t=new Date){const o=Math.floor((t.getTime()-e.getTime())/1e3);let n="ok";return Math.floor(o/31536e3)>=1||Math.floor(o/2592e3)>=1||Math.floor(o/604800)>=1?n="danger":Math.floor(o/86400)>=1&&(n="warning"),{label:Yo(e,!0),tooltip:Yo(e),status:n}}var Mi=Object.defineProperty,Bi=Object.getOwnPropertyDescriptor,Ni=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?Bi(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&Mi(t,o,r),r};const Di=36e5;let Li=class extends lit_element_s{constructor(){super(),Ye(Fe,Ue,je,We)}render(){return this.snoozed?Wt`
				<gk-tooltip>
		...
		`}onSnoozeActionCore(e){this.dispatchEvent(new CustomEvent("gl-snooze-action",{detail:{expiresAt:e,snooze:this.snoozed}}))}onUnsnoozeClick(e){e.preventDefault(),this.onSnoozeActionCore()}onSelectDuration(e){e.preventDefault();const t=e.detail.target.dataset.value;if(!t)return;if("unlimited"===t)return void this.onSnoozeActionCore();const o=new Date;let n=o.getTime();switch(t){case"1hr":n+=Di;break;case"4hr":n+=4*Di;break;case"tomorrow-9am":o.setDate(o.getDate()+1),o.setHours(9,0,0,0),n=o.getTime()}this.onSnoozeActionCore(new Date(n).toISOString())}};Li.styles=[Co,Pi],Ni([ro({reflect:!0})],Li.prototype,"snoozed",2),Li=Ni([no("gl-snooze")],Li);var zi=Object.defineProperty,Ii=Object.getOwnPropertyDescriptor,Hi=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?Ii(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&zi(t,o,r),r};let Fi=class extends lit_element_s{constructor(){super(),this.isCurrentBranch=!1,this.isCurrentWorktree=!1,this.hasWorktree=!1,this.hasLocalBranch=!1,Ye(Ve,ze,De,Re,Pe,qe,Te,We)}get lastUpdatedDate(){return new Date(this.pullRequest.date)}get assignees(){const e=this.pullRequest?.assignees;if(null==e)return[];const t=this.pullRequest.author;return null!=t?e.filter((e=>e.name!==t.name)):e}get indicator(){return null==this.pullRequest?"":"ChangesRequested"===this.pullRequest.reviewDecision?"changes":"Approved"===this.pullRequest.reviewDecision&&"Mergeable"===this.pullRequest.mergeableState?"ready":"Conflicting"===this.pullRequest.mergeableState?"conflicting":""}get dateStyle(){return`indicator-${Oi(this.lastUpdatedDate).status}`}get participants(){const e=[];function t(t,o){const n=e.find((e=>e.member.name===t.name));null!=n?n.roles.push(o):e.push({member:t,roles:[o]})}return null!=this.pullRequest?.author&&t(this.pullRequest.author,"author"),null!=this.pullRequest?.assignees&&this.pullRequest.assignees.forEach((e=>t(e,"assigned"))),null!=this.pullRequest?.reviewRequests&&this.pullRequest.reviewRequests.forEach((e=>t(e.reviewer,"reviewer"))),e}render(){if(this.pullRequest)return Wt`
			<gk-focus-row>
				<span slot="pin">
					<gk-tooltip>
						<a
				...
				<gk-focus-item>
					...
					<span slot="people">
						<gk-avatar-group>
							${So(this.participants.length>0,(()=>Wt`
									${Ao(this.participants,(e=>e.member.url),(e=>Wt`<gk-avatar
					...
					<div slot="repo" class="repo-branch">
						<gk-tag class="repo-branch__tag" full @click=${this.onOpenBranchClick}>
							...
							${!0===this.pullRequest.refs?.isCrossRepository?Wt`${this.pullRequest.refs?.head.owner}:${this.pullRequest.refs?.head.branch}`:this.pullRequest.refs?.head.branch}
						</gk-tag>
		...
		`}onOpenBranchClick(e){this.dispatchEvent(new CustomEvent("open-branch",{detail:this.pullRequest}))}onOpenWorktreeClick(e){if(this.isCurrentWorktree)return e.preventDefault(),void e.stopImmediatePropagation();this.dispatchEvent(new CustomEvent("open-worktree",{detail:this.pullRequest}))}onSwitchBranchClick(e){if(this.isCurrentBranch||this.hasWorktree)return e.preventDefault(),void e.stopImmediatePropagation();this.dispatchEvent(new CustomEvent("switch-branch",{detail:this.pullRequest}))}onSnoozeAction(e){e.preventDefault(),this.dispatchEvent(new CustomEvent("snooze-item",{detail:{item:this.pullRequest,expiresAt:e.detail.expiresAt,snooze:this.snoozed}}))}onPinClick(e){e.preventDefault(),this.dispatchEvent(new CustomEvent("pin-item",{detail:{item:this.pullRequest,pin:this.pinned}}))}};Fi.styles=[Co,To,Ri,Ei,Pi,Ti,tt``],Hi([ro({type:Number})],Fi.prototype,"rank",2),Hi([ro({type:Object})],Fi.prototype,"pullRequest",2),Hi([ro({type:Boolean})],Fi.prototype,"isCurrentBranch",2),Hi([ro({type:Boolean})],Fi.prototype,"isCurrentWorktree",2),Hi([ro({type:Boolean})],Fi.prototype,"hasWorktree",2),Hi([ro({type:Boolean})],Fi.prototype,"hasLocalBranch",2),Hi([ro()],Fi.prototype,"pinned",2),Hi([ro()],Fi.prototype,"snoozed",2),Fi=Hi([no("gk-pull-request-row")],Fi);var Ui=Object.defineProperty,ji=Object.getOwnPropertyDescriptor,qi=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?ji(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&Ui(t,o,r),r};let Vi=class extends lit_element_s{constructor(){super(),Ye(Ve,ze,De,Re,Pe,qe,We)}get lastUpdatedDate(){return new Date(this.issue.date)}get dateStyle(){return`indicator-${Oi(this.lastUpdatedDate).status}`}get assignees(){const e=this.issue?.assignees;if(null==e)return[];const t=this.issue.author;return null!=t?e.filter((e=>e.avatarUrl!==t.avatarUrl)):e}render(){if(this.issue)return Wt`
			<gk-focus-row>
				<span slot="pin">
					<gk-tooltip>
						<a
				...
				<gk-focus-item>
					...
					<span slot="people">
						<gk-avatar-group>
							${So(null!=this.issue.author,(()=>Wt`<gk-avatar
										src="${this.issue.author.avatarUrl}"
										title="${this.issue.author.name} (author)"
									></gk-avatar>`))}
							${So(this.assignees.length>0,(()=>Wt`
									${Ao(this.assignees,(e=>e.url),(e=>Wt`<gk-avatar
												src="${e.avatarUrl}"
		...
		`}focusItemsContent(){return this.isLoading?this.loadingContent():0===this.sortedItems.length?Wt`
			...
			${Ao(this.sortedItems,((e,t)=>`item-${t}-${e.isPullrequest?`pr-${e.state.pullRequest.id}`:`issue-${e.state.issue.id}`}`),(({isPullrequest:e,rank:t,state:o,isPinned:n,isSnoozed:i})=>So(e,(()=>Wt`<gk-pull-request-row
							...
							></gk-pull-request-row>`),(()=>Wt`<gk-issue-row
								.rank=${t}
								.issue=${o.issue}
								.pinned=${n}
								.snoozed=${i}
								.enrichedId=${o.enrichedId}
							></gk-issue-row>`))))}
		`}render(){return null==this.state?this.loadingContent():Wt`
			<div class="app">
						...
						<header class="app__header">
							<div class="app__header-group">
								<nav class="tab-filter" id="filter-focus-items">
									${ho(this.tabFilterOptionsWithCounts,(({label:e,value:t,count:o},n)=>Wt`
											<button
								...
								<gk-popover>
									...
									<gk-menu class="mine-menu" @select=${this.onSelectMineFilter}>
										${ho(this.mineFilterOptions,(({label:e,value:t},o)=>Wt`
												<gk-menu-item
													data-value="${t}"
		...
		`}onSearchInput(e){const t=e.target.value;""===t||t.length<3?this.searchText=void 0:this.searchText=t}onSelectMineFilter(e){const t=e.detail?.target;if(null!=t?.dataset?.value){this.selectedMineFilter=t.dataset.value;const e=t.closest("gk-popover");e?.hidePopover()}}createRenderRoot(){return this}};Qi.styles=[Co],Yi([lo("#subscription-gate",!0)],Qi.prototype,"subscriptionEl",2),Yi([lo("#connection-gate",!0)],Qi.prototype,"connectionEl",2),Yi([lo("#subscription-gate-badge",!0)],Qi.prototype,"subScriptionBadgeEl",2),Yi([ao()],Qi.prototype,"selectedTabFilter",2),Yi([ao()],Qi.prototype,"selectedMineFilter",2),Yi([ao()],Qi.prototype,"searchText",2),Yi([ro({type:Object})],Qi.prototype,"state",2),Qi=Yi([no("gl-focus-app")],Qi);class FocusApp extends App{constructor(){super("FocusApp")}onInitialize(){this.attachState()}onBind(){const e=super.onBind?.()??[];return e.push(E.on("gk-pull-request-row","open-worktree",((e,t)=>this.onOpenWorktree(e,t))),E.on("gk-pull-request-row","open-branch",((e,t)=>this.onOpenBranch(e,t))),E.on("gk-pull-request-row","switch-branch",((e,t)=>this.onSwitchBranch(e,t))),E.on("gk-pull-request-row","snooze-item",((e,t)=>this.onSnoozeItem(e,!1))),E.on("gk-pull-request-row","pin-item",((e,t)=>this.onPinItem(e,!1))),E.on("gk-issue-row","snooze-item",((e,t)=>this.onSnoozeItem(e,!0))),E.on("gk-issue-row","pin-item",((e,t)=>this.onPinItem(e,!0)))),e}get component(){return null==this._component&&(this._component=document.getElementById("app")),this._component}attachState(){this.component.state=this.state}onOpenBranch(e,t){null!=e.detail?.refs?.head&&this.sendCommand(a,{pullRequest:e.detail})}onSwitchBranch(e,t){null!=e.detail?.refs?.head&&this.sendCommand(c,{pullRequest:e.detail})}onOpenWorktree(e,t){null!=e.detail?.refs?.head&&this.sendCommand(r,{pullRequest:e.detail})}onSnoozeItem(e,t){t?this.sendCommand(d,{issue:e.detail.item,expiresAt:e.detail.expiresAt,snooze:e.detail.snooze}):this.sendCommand(l,{pullRequest:e.detail.item,expiresAt:e.detail.expiresAt,snooze:e.detail.snooze})}onPinItem(e,t){t?this.sendCommand(u,{issue:e.detail.item,pin:e.detail.pin}):this.sendCommand(h,{pullRequest:e.detail.item,pin:e.detail.pin})}onMessageReceived(e){if(e.method===p.method)o(p,e,(e=>{this.state=e.state,this.setState(this.state),this.attachState()}));else super.onMessageReceived?.(e)}}new FocusApp;var Ji=t.i;export{Ji as FocusApp};