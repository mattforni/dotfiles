...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand(exports.commands.start, () => {
        CatCodingPanel.createOrShow(getExtensionUri());
    }));
    context.subscriptions.push(vscode.commands.registerCommand(exports.commands.refactor, () => {
    ...
    if (vscode.window.registerWebviewPanelSerializer) {
        ...
        vscode.window.registerWebviewPanelSerializer(CatCodingPanel.viewType, {
            async deserializeWebviewPanel(webviewPanel, state) {
                ...
                webviewPanel.webview.options = getWebviewOptions(getExtensionUri());
                CatCodingPanel.revive(webviewPanel, getExtensionUri());
            },
        });
    }
}
...
CatCodingPanel.viewType = 'cspellConfigViewerV2';
function getNonce() {
    let text = '';
